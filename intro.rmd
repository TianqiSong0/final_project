...
Plot part
1. Divide data into four catagories as one plot will be too unfriendly to read: 
    . % of loss from retail/institutional to consumers (decreased>=50%)
    . % of loss from retail/institutional to consumers (decreased<50%)'
    . % of loss from retail/institutional to consumers (increased>=50%)
    . % of loss from retail/institutional to consumers (increased<50%)
2. Transpose and sort values
3. Create four groups of plots
4. Create total average losses plot